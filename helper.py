...
# Private donations - Complete in v0.8
# Withdrawls dm tx private key - Won't do
# Add withdrawal address verification https://github.com/0x9090/CrypocurrencyAddressValidation - Won't do
# QR code for your public address - Complete in 0.7
# Monero Ecosystem integration
